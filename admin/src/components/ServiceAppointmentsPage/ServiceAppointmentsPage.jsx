...
import { BadgeIndianRupee, Calendar, Clock, Loader2, Phone, SearchIcon, XIcon, User, CheckCircle, XCircle } from "lucide-react";
    ...
    <div className={sas.container}>
      <header className={sas.headerContainer}>
        ...
        <div className={sas.searchContainer}>
          ...
          <div className={sas.searchInfo}>
            <div>
              {displayList.length}{" "}
              {displayList.length !== 1 ? "results" : "result"}
            </div>
            <div>
      ...
      <div className={sas.legendContainer}>
        <div className={sas.legendItem}>
          <div className={`${sas.legendDot} bg-amber-400`}/> <span>Pending</span>
        </div>

         <div className={sas.legendItem}>
          <div className={`${sas.legendDot} bg-emerald-400`}/> <span>Confirmed</span>
        </div>

         <div className={sas.legendItem}>
          <div className={`${sas.legendDot} bg-red-400`}/> <span>Canceled</span>
        </div>

         <div className={sas.legendItem}>
          <div className={`${sas.legendDot} bg-sky-400`}/> <span>Completed</span>
        </div>

         <div className={sas.legendItem}>
          <div className={`${sas.legendDot} bg-indigo-400`}/> <span>Rescheduled</span>
        </div>
      </div>
