        ...
        <div className={sd.table.container}>
          ...
          <div className={sd.table.body}>
            {loading ? (
              ...
              <div className={sd.states.empty}>No services available</div>
            ) : (
                ...
                return (
                  <div key={s.id} className={sd.table.row}>
                    ...
                    <div className={sd.table.tabletView}>
                      ...
                      <div className={`${sd.table.tabletCell} text-red-500`}>
                        {s.canceled}
                      </div>
                      <div className={`${sd.table.tabletCell} text-right`}>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className={sd.table.mobileServiceHeader}>
                            <h3 className={sd.table.mobileServiceName}>
                              {s.name}
                            </h3>
                          ...
                          <div className={sd.table.mobileStatsContainer}>
                            <div className={sd.table.mobileStatItem("emerald")}>
                              <Calendar size={14} />
                            ...
                            <div className={sd.table.mobileStatItem("red")}>
                              <XCircle size={14} />
