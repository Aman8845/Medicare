...
const AddService = ({ serviceId }) => {
  ...
  function isSelectedDateTimeInPast() {
    ...
    return sel.getTime() < Date.now() - 60_000;
  }
        ...
        <div className={ad.grids.main}>
          ...
          <div className="lg:col-span-2 md:col-span-1 col-span-1 space-y-6">
            <div className={ad.grids.formFields}>
              <div>
                <label className={ad.labels.standard}>Service name</label>
                <input
                  value={serviceName}
              ...
              <div>
                <label className={ad.labels.standard}>Price</label>
                <input
                  value={price}
                ...
                <div className="mt-3">
                  <label className={ad.labels.standard}>Availability</label>
                  <select
                    value={availability}
            ...
            <div>
              <label className={ad.labels.standard}>About this service</label>
              <textarea
                value={about}
            ...
            <div>
              ...
              <div className={ad.instructions.container(errors.instructions)}>
                {instructions.map((ins, idx) => (
                  <div key={idx} className={ad.instructions.item}>
                    <div className={ad.icon.number}>{idx + 1}.</div>
                    <input
                      value={ins}
            ...
            {/* slot controls */}
            <div className={ad.slots.container(errors.slots)}>
              ...
              <div>
                ...
                <div className={ad.grids.slotsGrid}>
                  {slots.length === 0 ? (
                    ...
                    slots.map((s, idx) => (
                      <div key={s} className={ad.slots.slotItem}>
                        <div className="flex items-center gap-2 min-w-0">
                          <Clock className={ad.icon.clock} />
                          <div className={ad.slots.slotText}>{s}</div>
                        </div>
                        <button
                          type="button"
