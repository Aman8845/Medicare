...
import VerfiyPaymentPage from "../VerfiyPaymentPage";
    ...
    <>
      ...
      <div className="overflow-x-hidden bg-white text-gray-900">
        <Routes>
          ...
          {/* for the payment verfications */}
          <Route path="/appointment/success" element={<VerfiyPaymentPage />} />
          <Route path="/appointment/cancel" element={<VerfiyPaymentPage />} />
