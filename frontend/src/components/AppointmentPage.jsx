...
const AppointmentPage = () => {
  ...
  return (
    <div className={ap.pageContainer}>
      <Toaster position="top-right" />
      <div className={ap.maxWidthContainer}>
        <h1 className={ap.doctorTitle}>Your Doctor Appointments</h1>

        {loadingDoctors && (
          <div className={ap.loadingText}>Loading Doctors...</div>
        )}

        {!loadingDoctors && appointmentData.length === 0 && (
          <div className={ap.emptyStateText}>No doctor appointments found</div>
        )}

        <div className={ap.doctorGrid}>
        ...
        <h2 className={ap.serviceTitle}>Your Booked Services</h2>

        {loadingDoctors && (
          <div className={ap.serviceLoadingText}>
            Loading Service Bookings...
          </div>
        )}

        {!loadingServices && serviceData.length === 0 && (
          <div className={ap.serviceEmptyStateText}>
            No service bookings found
          </div>
        )}

        <div className={ap.serviceGrid}>
          {serviceData.map((srv) => (
